...
class PanteraParser(BaseVCParser):
    def __init__(self, url: str = "https://panteracapital.com/portfolio/", debug_mode=False):
    ...
    def parse_company_cards(self, content: str) -> list:
        ...
        cards = tree.xpath(
            '//div[contains(@class,"card-back") and contains(@class, "card-face")]')
        ...
        for card in cards:
            try:
                ...
                link_elements = card.xpath('.//a[@class="url-website"]')
                links = {}
