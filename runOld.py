...
from aizen.agents.baseOld import BaseAgent, AgentConfig
from aizen.data.news.blockworks import Blockworks
from aizen.social.twitterclient import TwitterClient
...
class AgentRunner:
    ...
    async def initialize_agent(self):
        ...
        try:
            ...
            if "twitterclient__post_tweet" in self.agent_config["tools"]:
                twitter_client = TwitterClient()
                self.agent.register_tool("twitterclient.post_tweet", twitter_client.post_tweet)
